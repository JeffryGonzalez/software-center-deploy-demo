# msw-lens context
generated: 2026-05-20T15:11:57.170Z
entry: src\app\areas\catalog\feature-catalog\pages\overview.ts
...
import { CatalogListItem } from '../../data-catalog/types';
      ...
      @if (catalogResource.hasValue()) {
        <div class="overflow-x-auto">
          <table class="table table-zebra">
            ...
            <tbody>
              @for (item of catalogResource.value(); track item.id) {
                <tr>
                  <td>{{ item.title }}</td>
                  <td>{{ item.vendor }}</td>
                </tr>
...
export class OverviewPage {
  catalogResource = httpResource<CatalogListItem[]>(() => '/api/catalog');
}
```
